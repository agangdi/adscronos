  ...
  return (
    <div className="min-w-[220px] select-none max-w-[220px] w-[65vw] sm:w-[220px] self-stretch flex flex-col">
      <div className="w-full">
        <div
          className="w-full aspect-square rounded-2xl flex items-center justify-center ring ring-black/5 shadow-[0px_2px_6px_rgba(0,0,0,0.06)]"
          style={{
            background: apiData.bgGradient || 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'
          }}
        >
          <div className="text-center text-white">
            <div className="text-6xl font-bold mb-2">{apiData.letter}</div>
            <Database className="h-8 w-8 mx-auto opacity-80" aria-hidden="true" />
          </div>
        </div>
      </div>
